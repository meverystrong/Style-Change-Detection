...
def predict_task(input_path, output_path):
    model.load_weights('S:/python/style_change_detection2022/finetune_paragraph_authors_electra_base/best_model.weights')
...
if __name__ == '__main__':
    ...
    input_path = 'S:/python/style_change_detection2022/pan22/dataset2/test'
    output_path = 'S:/python/style_change_detection2022/output22/2/dataset2'
