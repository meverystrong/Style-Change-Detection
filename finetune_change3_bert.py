...
config_path = 'S:/python/model/uncased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = 'S:/python/model/uncased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = 'S:/python/model/uncased_L-12_H-768_A-12/vocab.txt'
...
# 建立模型，加载权重
output = Dropout(rate)(bert.model.output)
output = Dense(
    units=num_classes,
    activation='softmax',
