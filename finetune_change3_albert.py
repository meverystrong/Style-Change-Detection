...
config_path = 'S:/python/model/albert_base_tfv3/assets/albert_config.json'
checkpoint_path = 'S:/python/model/albert_base_tfv3/variables/variables'
spm_path = 'S:/python/model/albert_base_tfv3/assets/30k-clean.model'
