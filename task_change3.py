...
def predict_task(input_path, output_path):
    model.load_weights('S:/python/style_change_detection2022/finetune_task3/best_model.weights')
...
if __name__ == '__main__':
    ...
    input_path = 'S:/python/style_change_detection2022/pan22/dataset3/test'
    output_path = 'S:/python/style_change_detection2022/output22/task3'
