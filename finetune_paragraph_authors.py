...
train_path = 'pan22/dataset2/train'
validation_path = 'pan22/dataset2/validation'
test_path = 'pan22/dataset2/test'
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_acc > self.best_val_acc:
            ...
            model.save_weights('1/best_model.weights')
            model.save('1/best_model.h5')
...
if __name__ == '__main__':
    ...
    model.load_weights('1/best_model.weights')
    with open('1/result.txt', 'a', encoding='utf-8') as result_file:
