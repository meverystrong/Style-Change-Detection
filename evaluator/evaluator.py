...
def main():
    ...
    parser = argparse.ArgumentParser(description='PAN22 Style Change Detection Task: Evaluator')
    ...
    task1_solutions = read_solution_files(os.path.join(args.predictions, 'S:/python/style_change_detection2022/output22/task1_large_64+32'))
    task1_truth = read_ground_truth_files(os.path.join(args.truth, 'pan22/dataset1/validation'))
    ...
    task2_solutions = read_solution_files(os.path.join(args.predictions, 'S:/python/style_change_detection2022/output22/task2'))
    task2_truth = read_ground_truth_files(os.path.join(args.truth, 'pan22/dataset2/validation'))
    try:
    ...
    task3_solutions = read_solution_files(os.path.join(args.predictions, 'S:/python/style_change_detection2022/output22/task3'))
    task3_truth = read_ground_truth_files(os.path.join(args.truth, 'pan22/dataset3/validation'))
    try:
